...
class ResourceManager():
    ...
    def _calculate_length_crunches(self, length, success_mod):
        return (math.log(pow(math.e, 0.5) + (length - 1)) + self.euller_mascheroni_constant) * success_mod
    
    def _calculate_digits_crunches(self, digits, success_mod):
        return (math.log(pow(math.e, 0.5) + (pow(10, digits) - 1)) + self.euller_mascheroni_constant) * success_mod
